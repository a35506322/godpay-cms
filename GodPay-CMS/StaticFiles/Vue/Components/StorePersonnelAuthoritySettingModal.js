export default {
    props: ['storePersonnelAuthority', 'tempUid', 'tempLoading'],
    components: {
        'pCard': primevue.card
    },
    data: function () {
    ...
    watch: {
        storePersonnelAuthority: {
            handler: function (newVal, oldVal) {
                this.tempModel = this.changeJson(this.storePersonnelAuthority);
            },
            deep: true
        }
    },
    template: `
    <p-dialog header="特店人員權限設定" v-model:visible="displayModal" class="p-modal p-modal-lg p-modal-x1 p-modal-xx1" v-bind:position="'top'" v-bind:modal="true">
